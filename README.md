...
**Discover movies and TV shows with the power of AI.** Watchly combines TMDB's extensive database with Google Gemini's intelligence to deliver personalized recommendations, interactive quizzes, and a beautiful browsing experience.
...
<div style="display: flex; overflow-x: auto; scroll-snap-type: x mandatory; gap: 20px; padding: 20px 0;">
  <img src="Screenshots/home page.png" alt="Home Page - Interactive Hero Carousel" style="width: 600px; scroll-snap-align: start; border-radius: 12px; box-shadow: 0 4px 6px rgba(0,0,0,0.1);">
  <img src="Screenshots/moviedetails.png" alt="Movie Details - Comprehensive Information" style="width: 600px; scroll-snap-align: start; border-radius: 12px; box-shadow: 0 4px 6px rgba(0,0,0,0.1);">
  <img src="Screenshots/watchlist.png" alt="Watchlist - Personal Collection" style="width: 600px; scroll-snap-align: start; border-radius: 12px; box-shadow: 0 4px 6px rgba(0,0,0,0.1);">
  <img src="Screenshots/recomendationspage.png" alt="Smart Recommendations - Advanced Filtering" style="width: 600px; scroll-snap-align: start; border-radius: 12px; box-shadow: 0 4px 6px rgba(0,0,0,0.1);">
  <img src="Screenshots/gamepage.png" alt="Interactive Quiz - AI-Generated Questions" style="width: 600px; scroll-snap-align: start; border-radius: 12px; box-shadow: 0 4px 6px rgba(0,0,0,0.1);">
  <img src="Screenshots/trending movies.png" alt="Trending Movies - Weekly Hot Picks" style="width: 600px; scroll-snap-align: start; border-radius: 12px; box-shadow: 0 4px 6px rgba(0,0,0,0.1);">
</div>
